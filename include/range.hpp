...
// Usage:
// indices(X) - return a list of indices of the std structure X (e.g. an std::vector)
// range(X) - return a list of numbers, ranging from 0 up to X-1
// for(auto i:indices(X)){} - iterates over all indices of the std structure X
// for(auto i:range(X)){} - iterates from 0 up to X-1
